...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const page1 = new Discord.MessageEmbed()
      ...
      .addField(`**Want ${client.user.username} in your server?**`, `Invite ${client.user.username} [__here__](https://discord.com/api/oauth2/authorize?client_id=1053322059255656468&permissions=8&scope=bot)`)
      .addField('**:newspaper: Latest News - Fri 18 Dec**', 'Bot Development Started')
